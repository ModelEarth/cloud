...
The UI_ACCESS_TOKEN from your .env file (generated by rotate-token.sh) will be used for Google Cloud Run
</span>

## Update Config

Start Flask with the [Webroot Manager](../../team/setup/)

    start cloud using guidance in team/AGENTS.md

<br>

<span class="num">2</span> **[Add config in Start Form](start) or in [team/admin/cloud](../../team/admin/cloud/)**

## Features

- **Configuration Interface** - Web-based form to edit settings for config files
...
View [RealityStream](/realitystream) for live data visualization and model outputs.  
View [Streamlit Interface](/streamlit/) for advanced data processing and visualization tools.
...
<!--Probably not necessary for deploying-->
...
<!--
TO DO: form where users can enter their Google ProjectID, GitHub repo+token to populate in the commands.
We might add deployment cmds for [Thundercompute.com](https://www.thundercompute.com)
-->
NOTE: Run the gcloud cmd in Claude Code CLI and you won't need to install gcloud.


Initialize gcloud - Open a terminal in the folder where your site will reside. (For example: cloud/run/)
...
<span class="localdev" style="display:none">For Local Dev, skip this section and continue to testing below.</span>

<span class="clouddev" style="display:none">Run rotate-token.sh to build and deploy securely. Use the UI_ACCESS_TOKEN printed in the terminal later for login access.
